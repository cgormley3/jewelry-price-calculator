  ...
  return (
    <div className="grid grid-cols-1 gap-8 pt-6 mt-0 md:pt-4 px-4 md:px-6 lg:px-8 pb-[calc(6.25rem+env(safe-area-inset-bottom,0px))] md:pb-8 min-w-0">
      <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border-2 border-brand min-h-[400px] md:min-h-0 min-w-0">
        <h2 className="text-xl font-black uppercase italic tracking-tighter mb-8 text-foreground text-left underline decoration-brand decoration-4 underline-offset-8">1. MATERIAL CALCULATION DETAIL</h2>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 text-left">
          <div className="space-y-6 min-w-0">
            <div className="bg-stone-50 p-6 md:p-8 rounded-[2rem] border border-stone-100 text-left">
              ...
              <div className="font-mono text-sm bg-white p-6 rounded-2xl border border-stone-100 text-center shadow-sm">
                <p className="text-foreground font-bold break-words">Cost = (Spot ÷ 31.1035) × Grams × Purity</p>
              </div>
            </div>
          ...
          <div className="bg-stone-50 p-6 md:p-8 rounded-[2rem] border border-stone-100 text-left min-w-0">
            <h3 className="text-xs font-black text-foreground uppercase tracking-widest mb-6">PURITY CONSTANTS:</h3>
      ...
      <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border-2 border-brand min-h-[400px] md:min-h-0 min-w-0">
        <h2 className="text-xl font-black uppercase italic tracking-tighter mb-8 text-foreground text-left underline decoration-brand decoration-4 underline-offset-8">2. ADVANCED PRICING LOGIC</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          <div className="p-6 md:p-8 rounded-[2rem] border border-stone-100 bg-stone-50 transition-all flex flex-col justify-between">
            <div>
              <h3 className="text-xs font-black text-foreground uppercase tracking-widest mb-6">STONE PRICING</h3>
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-bold text-foreground break-words">Stone Retail = Stone Cost × Markup</span>
                </div>
          ...
          <div className="p-6 md:p-8 rounded-[2rem] border border-stone-100 bg-stone-50 transition-all flex flex-col justify-between">
            <div>
              <h3 className="text-xs font-black text-foreground uppercase tracking-widest mb-6">OVERHEAD CALCULATION</h3>
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-bold text-foreground break-words">Flat: Simple dollar addition</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-white border border-stone-200 flex items-center justify-center font-black text-xs shrink-0">%</div>
                  <span className="text-xs font-bold text-foreground break-words">Percent: (Metal + Labor + Other + Stones) × Percentage</span>
                </div>
      ...
      <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border-2 border-brand min-h-[400px] md:min-h-0 min-w-0">
        <h2 className="text-xl font-black uppercase italic tracking-tighter mb-8 text-foreground text-left underline decoration-brand decoration-4 underline-offset-8">3. PRICE FORMULA DETAIL</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 text-left">
          <div className="p-6 md:p-8 rounded-[2rem] border border-stone-100 bg-stone-50 transition-all flex flex-col justify-between">
            <div>
              <h3 className="text-xs font-black text-foreground uppercase tracking-widest mb-2">FORMULA A (STANDARD MULTIPLIER)</h3>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-xs font-bold text-foreground break-words">Metal + Labor + Other + Overhead</span>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-xs font-bold text-foreground break-words">(Base Cost × {retailMultA}) + (Stones × Stone Markup)</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-xs font-bold text-foreground break-words">Base Cost + Stone Cost</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="p-6 md:p-8 rounded-[2rem] border border-stone-100 bg-stone-50 transition-all flex flex-col justify-between">
            <div>
              <h3 className="text-xs font-black text-foreground uppercase tracking-widest mb-2">FORMULA B (MATERIALS MARKUP)</h3>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <span className="text-xs font-bold text-stone-400 block mb-1">Base Cost =</span>
                    <span className="text-xs font-bold text-foreground break-words">((Metal + Other) × {markupB}) + Labor + Overhead</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-lg bg-white border border-stone-200 flex items-center justify-center font-black text-xs shrink-0 mt-0.5">R</div>
                  <div className="flex-1">
                    <span className="text-xs font-bold text-stone-400 block mb-1">Retail Price =</span>
                    <span className="text-xs font-bold text-foreground break-words">(Base Cost × 2) + (Stones × Stone Markup)</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-lg bg-white border border-stone-200 flex items-center justify-center font-black text-xs shrink-0 mt-0.5">W</div>
            ...
            <div>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <span className="text-xs font-bold text-stone-400 block mb-1">Base Cost</span>
                    <span className="text-xs text-foreground break-words">Your materials + labor + overhead. Combine values with +, −, ×, ÷.</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-xs text-foreground break-words">Typically Base + Stone cost, or your own markup.</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-xs text-foreground break-words">Final price. Can use Base, multipliers, and stone retail.</span>
                  </div>
                </div>
              </div>
              <button
                ...
                className="w-full py-3 rounded-xl text-[10px] font-black uppercase bg-brand text-white hover:bg-forest transition shadow-sm"
              >
                Create a formula →
              </button>
            </div>
