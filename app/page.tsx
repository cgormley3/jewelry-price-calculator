...
export default function Home() {
  ...
  const deleteInventoryItem = async (id: string) => {
    ...
    else setInventory(inventory.filter(item => item.id !== id));
  };
                  ...
                  <div key={item.id} className="bg-white p-6 rounded-[2rem] border shadow-sm flex flex-col sm:row justify-between items-center gap-4 hover:border-blue-200 transition">
                    <div className="flex-1 w-full">
                      ...
                      <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">
                        {new Date(item.created_at).toLocaleDateString()} | Strategy {item.strategy}
                      </p>
                    </div>
                    <div className="flex gap-8 w-full sm:w-auto sm:text-right border-t sm:border-t-0 pt-4 sm:pt-0">
                      <div>
                      ...
                      <div>
                        <p className="text-[9px] font-black text-blue-600 uppercase italic">Retail MSRP</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-slate-50 p-6 rounded-2xl space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-[10px] font-bold text-slate-500">
                  ...
                  <p>10K Gold: 41.7%</p><p>Sterling: 92.5%</p>
